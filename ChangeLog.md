...
- Chg: The Request::getParams() method will not convert special characters into `_` any more, see https://stackoverflow.com/questions/68651/get-php-to-stop-replacing-characters-in-get-or-post-arrays
